# ClaimsAssessmentEvent

## Overview

**Type**: Event  
**Proto**: `insuretech.ai.events.v1.ClaimsAssessmentEvent`  
**Purpose**: Event emitted when claims assessment

**Proto Comment**: Event: Claims assessment completed

## Description

<!-- Add detailed description here -->
This event is emitted when specific conditions are met in the system.
