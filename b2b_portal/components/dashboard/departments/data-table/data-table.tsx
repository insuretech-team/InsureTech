...
type DataTableProps<TData, TValue> = {
  ...
  /** Organisation context — passed to the internal AddDepartmentModal */
  organisationId?: string;
  /** If provided, clicking Add Department calls this instead of internal modal */
  onAddClick?: () => void;
  onRefresh?: () => void;
};
...
export function DataTable<TData, TValue>({
  ...
  const [addDepartmentModalOpen, setAddDepartmentModalOpen] =
  ...
  return (
    <>
        ...
        <div className="border-b px-4 py-3 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              onClick={() => onAddClick ? onAddClick() : setAddDepartmentModalOpen(true)}
            >
              <LuCirclePlus />
              ...
              {loading ? (
                ...
                table.getRowModel().rows.map((row) => (
                  <tr
                    key={row.id}
                    className={[
                      "border-b last:border-b-0 table-row-hover",
      ...
      <AddDepartmentModal
        ...
        onSaved={() => { setAddDepartmentModalOpen(false); onRefresh?.(); }}
      />
    </>
  );
}
