...
// ─── OrgMember — defined locally to avoid SDK dependency in browser bundle ────
// Shape mirrors the @lifeplus/insuretech-sdk OrgMember type exactly.
...
export type OrgMember = {
  ...
  joined_at?: string;
  // Common user fields returned by API
  email?: string;
  full_name?: string;
