...
func main() {
	...
	// TODO: Initialize payment server when implemented
	// paymentServer, err := paymentpkg.NewPaymentServer(sqlDB)
	// if err != nil {
	// 	logger.Fatal("Failed to create payment server", zap.Error(err))
	// }
	_ = sqlDB
	...
	// TODO: Register payment service when implemented
	// paymentservicev1.RegisterPaymentServiceServer(grpcServer, paymentServer)
