...
func TestFileRepository_Create(t *testing.T) {
	...
	file := &storageentityv1.StoredFile{
		...
		SizeBytes:     12345,
		StorageKey:    "inscore/assets/test-tenant-123/2025/01/test.jpg",
		Bucket:        "merchbd",
		Url:           "https://merchbd.sgp1.digitaloceanspaces.com/inscore/assets/test-tenant-123/2025/01/test.jpg",
		CdnUrl:        "https://merchbd.sgp1.cdn.digitaloceanspaces.com/inscore/assets/test-tenant-123/2025/01/test.jpg",
...
func TestFileRepository_GetByID(t *testing.T) {
	...
	file := &storageentityv1.StoredFile{
		...
		SizeBytes:     54321,
		StorageKey:    "inscore/orders/test-tenant-123/2025/01/invoice.pdf",
		Bucket:        "merchbd",
		Url:           "https://merchbd.sgp1.digitaloceanspaces.com/inscore/orders/test-tenant-123/2025/01/invoice.pdf",
	...
	files := []*storageentityv1.StoredFile{
		{
			...
			ContentType: "image/jpeg",
			SizeBytes:   1000,
			StorageKey:  "inscore/assets/test-tenant-123/2025/01/image1.jpg",
			Bucket:      "merchbd",
			Url:         "https://merchbd.sgp1.digitaloceanspaces.com/inscore/assets/test-tenant-123/2025/01/image1.jpg",
			FileType:    storageentityv1.FileType_FILE_TYPE_IMAGE,
			IsPublic:    true,
			UploadedBy:  uploadedBy,
		},
		{
			...
			ContentType: "image/jpeg",
			SizeBytes:   2000,
			StorageKey:  "inscore/assets/test-tenant-123/2025/01/image2.jpg",
			Bucket:      "merchbd",
			Url:         "https://merchbd.sgp1.digitaloceanspaces.com/inscore/assets/test-tenant-123/2025/01/image2.jpg",
			FileType:    storageentityv1.FileType_FILE_TYPE_IMAGE,
			IsPublic:    true,
			UploadedBy:  uploadedBy,
		},
...
func TestFileRepository_Delete(t *testing.T) {
	...
	file := &storageentityv1.StoredFile{
		...
		ContentType: "image/jpeg",
		SizeBytes:   1000,
		StorageKey:  "inscore/assets/test-tenant-123/2025/01/to-delete.jpg",
		Bucket:      "merchbd",
		Url:         "https://merchbd.sgp1.digitaloceanspaces.com/inscore/assets/test-tenant-123/2025/01/to-delete.jpg",
		FileType:    storageentityv1.FileType_FILE_TYPE_IMAGE,
		IsPublic:    true,
		UploadedBy:  uploadedBy,
	}
...
func TestFileRepository_WithExpiration(t *testing.T) {
	...
	file := &storageentityv1.StoredFile{
		...
		ContentType: "image/jpeg",
		SizeBytes:   1000,
		StorageKey:  "inscore/assets/test-tenant-123/2025/01/temp.jpg",
		Bucket:      "merchbd",
		Url:         "https://merchbd.sgp1.digitaloceanspaces.com/inscore/assets/test-tenant-123/2025/01/temp.jpg",
		FileType:    storageentityv1.FileType_FILE_TYPE_IMAGE,
		IsPublic:    false,
		ExpiresAt:   expiresAt,
		UploadedBy:  uploadedBy,
