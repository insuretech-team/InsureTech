...
public sealed class ClaimsGrpcService : ClaimService.ClaimServiceBase
{
    ...
    private static Claim MapToProtoClaim(ClaimResponseDto dto)
    {
        var claim = new Claim
        {
            ...
            ClaimedAmount = new Insuretech.Common.V1.Money { Amount = dto.ClaimedAmount.Amount, Currency = dto.ClaimedAmount.Currency },
            ApprovedAmount = new Insuretech.Common.V1.Money { Amount = dto.ApprovedAmount.Amount, Currency = dto.ApprovedAmount.Currency },
