...
public class CreateProductCommandHandler : IRequestHandler<CreateProductCommand, Guid>
{
    ...
    private readonly InsuranceEngine.SharedKernel.Interfaces.IEventBus _eventBus;

    public CreateProductCommandHandler(IProductRepository productRepository, InsuranceEngine.SharedKernel.Interfaces.IEventBus eventBus)
    {
