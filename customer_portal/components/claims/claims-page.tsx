    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
          ...
          <Button className="sm:w-auto bg-[#8C34C7] hover:bg-[#8C34C7]/90 hover:cursor-pointer">
            File New Claim
          </Button>
        </div>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between text-sm">
                  <div>
                    ...
                    <p className="mt-1 text-lg font-bold text-[#8C34C7]">
                      {claim.claimAmount}
                    </p>
                  </div>
                ...
                <Button
                  variant="link"
                  size="sm"
                  className="h-auto gap-1 p-0 text-[#8C34C7] hover:text-[#8C34C7]/90"
                >
                  View Details
