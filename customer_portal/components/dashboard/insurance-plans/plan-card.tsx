    ...
    <div className="rounded-md border border-gray-50 bg-white shadow-sm">
      <div className="px-4 pt-3 pb-2">
        ...
        <div className="mt-1 flex items-center gap-2">
          <span className="text-sm font-semibold text-[#8C34C7]">
            ৳{plan.coverage}
          </span>
        </div>
        ...
        <div className="mt-2 space-y-2">
          <div className="flex items-center gap-2 text-sm text-gray-500">
            <span className="flex items-center">
              ...
              <span className="font-semibold text-[#8C34C7]">
                ৳{plan.premium}
              </span>
            </span>
          </div>
      ...
      >
        <div className="flex flex-col">
          ...
          <span
            className="ml-12 mt-0.5 text-md font-semibold text-[#8C34C7]"
        ...
        <Button
          variant="outline"
          className="bg-[#8C34C7] text-white hover:bg-[#8C34C7]"
        >
