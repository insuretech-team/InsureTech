...
const QuickAccess = () => {
  return (
    <div className="rounded-lg bg-gradient-to-r from-[#8C34C7] to-[#702A9F] p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        >
          <Link href="/payments" passHref className="flex space-x-4">
            <CreditCard className="size-5 text-[#8C34C7]" />
            <span className="font-medium text-[#8C34C7]">Make Payment</span>
          </Link>
        </Button>
        <Button
          variant="secondary"
        ...
        >
          <Link href="/claims" passHref className="flex space-x-4">
            <FileText className="size-5 text-[#8C34C7]" />
            <span className="font-medium text-[#8C34C7]">Claim Policy</span>
          </Link>
        </Button>
        <Button
          variant="secondary"
        ...
        >
          <Link href="/support" passHref className="flex space-x-4">
            <HelpCircle className="size-5 text-[#8C34C7]" />
            <span className="font-medium text-[#8C34C7]">Help & Support</span>
          </Link>
        </Button>
      </div>
    </div>
