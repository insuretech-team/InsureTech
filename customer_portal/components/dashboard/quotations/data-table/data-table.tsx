...
import AddQuotationModal from "../../../modals/add-quotation-modal";
...
export function DataTable<TData, TValue>({
  ...
  const [addQuotationModalOpen, setAddQuotationModalOpen] =
  ...
  return (
    <>
      <div className="rounded-lg border bg-white overflow-hidden">
        <div className="border-b px-4 py-3 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <LuCirclePlus />
              <span>Add Quotation Request</span>
            </Button>
          </div>
        </div>
      ...
      <AddQuotationModal
        open={addQuotationModalOpen}
        onOpenChange={setAddQuotationModalOpen}
      />
    </>
  );
}
