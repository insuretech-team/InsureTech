          ...
          <FieldGroup className="space-y-4">
            ...
            <Field>
              ...
              <Select name="insuranceType" required>
                ...
                <SelectContent>
                  <SelectItem className="focus:text-[#2b2b2b]" value="health">
                    Health
                  </SelectItem>
                  <SelectItem className="focus:text-[#2b2b2b]" value="life">
                    Life
                  </SelectItem>
                  <SelectItem className="focus:text-[#2b2b2b]" value="motor">
                    Motor
                  </SelectItem>
                  <SelectItem className="focus:text-[#2b2b2b]" value="travel">
                    Travel
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <Field>
              ...
              <Select name="plan" required>
                ...
                <SelectContent>
                  <SelectItem className="focus:text-[#2b2b2b]" value="basic">
                    Basic
                  </SelectItem>
                  <SelectItem className="focus:text-[#2b2b2b]" value="standard">
                    Standard
                  </SelectItem>
                  <SelectItem className="focus:text-[#2b2b2b]" value="premium">
                    Premium
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <Field>
              ...
              <Select name="department" required>
                ...
                <SelectContent>
                  <SelectItem className="focus:text-[#2b2b2b]" value="hr">
                    HR
                  </SelectItem>
                  <SelectItem className="focus:text-[#2b2b2b]" value="tech">
                    Tech
                  </SelectItem>
                  <SelectItem className="focus:text-[#2b2b2b]" value="accounts">
                    Accounts
                  </SelectItem>
                  <SelectItem className="focus:text-[#2b2b2b]" value="business">
                    Business
                  </SelectItem>
                </SelectContent>
              </Select>
