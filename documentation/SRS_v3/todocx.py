"""
SRS Markdown to DOCX Converter - FIXED VERSION
Converts SRS_V3_FINAL_SPEC.md to a well-formatted Word document with tables, headers, and styling
FIXED: Removed duplicate add_table_to_doc function that was causing table duplication
"""
...
def main():
    ...
    # File paths
    script_dir = Path(__file__).parent
    md_file = script_dir / "SRS_V3_FINAL_DRAFT.md"
    docx_file = script_dir / "SRS_V3_FINAL_DRAFT.docx"
    
    print("="*60)
    print("SRS Markdown to DOCX Converter - FINAL COMPLETE VERSION")
    print("="*60)
