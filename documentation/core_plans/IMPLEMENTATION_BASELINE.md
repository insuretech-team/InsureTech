...
- `backend/inscore/cmd/dbx` for migration and direct DB operations

Important implication:

The `dbx` note should not remain a standalone orphaned file. It is part of the platform baseline, not an isolated plan.
