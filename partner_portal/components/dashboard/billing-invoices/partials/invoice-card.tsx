  ...
  return (
    <div className="flex items-start justify-between gap-4 my-2 p-2 border border-gray-200 rounded-md">
      ...
      <div className="flex shrink-0 flex-col items-end gap-2">
        <p className="text-xs font-semibold text-[var(--primary-deep)]">
          ৳{amount}
        </p>
        ...
        {isPending ? (
          <button
            type="button"
            className="inline-flex items-center gap-1.5 rounded-md bg-[var(--primary-deep)] px-3 py-1.5 text-[11px] font-semibold text-white"
          >
            <Image
