        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="outline"
              size="icon"
              className="relative size-9 hover:text-[var(--primary-deep)] cursor-pointer border-0 bg-transparent"
            >
              <LuBell className="size-4" />
              <span className="absolute right-1 top-1 flex size-2 rounded-full bg-[var(--primary-deep)]" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="cursor-pointer justify-center text-[var(--primary-deep)] hover:bg-secondary hover:text-[var(--primary-deep)]">
