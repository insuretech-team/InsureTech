...
export const purchaseOrderColumns: ColumnDef<PurchaseOrders>[] = [
  {
    id: "srNo",
    header: "Sr. No.",
  ...
  },
  {
    ...
    header: ({ column }) => <SortHeader title="Order ID" column={column} />,
    cell: ({ row }) => (
        ...
        <details className="relative">
          ...
          <div className="absolute right-0 mt-2 w-40 rounded-md border bg-white shadow-sm z-20 overflow-hidden">
            <button
              ...
              type="button"
              onClick={() => alert(`Edit: ${quotation.purchaseOrderID}`)}
            >
            ...
            <button
              className="w-full px-3 py-2 text-left text-sm hover:bg-gray-50"
              type="button"
              onClick={() => alert(`Delete: ${quotation.purchaseOrderID}`)}
            >
