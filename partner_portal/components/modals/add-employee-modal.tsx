...
const focusPurple =
  "focus-visible:ring-[var(--primary-deep)] focus-visible:border-[var(--primary-deep)] focus-visible:ring-2";
              ...
              <Field>
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                  />
                  <LuCalendarDays className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-[var(--primary-deep)]" />
                </div>
              </Field>
