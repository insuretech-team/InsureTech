          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                ...
                <span className="ml-1 font-medium block text-[var(--primary-deep)]">
                  ৳ 25,000
                </span>
              </p>
            </div>
            ...
            <div className="text-right">
              <div className="flex items-center justify-end gap-1 ">
                <Sparkles className="text-[var(--primary-deep)]" size={16} />
              ...
              <div className="mt-1 flex items-center justify-end gap-1 ">
                <Clock className="text-[var(--primary-deep)]" size={14} />
...
const CoverageItem = ({ icon, label }: { icon: string; label: string }) => (
  <div className="flex items-center gap-3 rounded-md bg-[var(--bg-soft-primary)] px-3 py-3">
    <Image
      src={icon}
      width={24}
      height={24}
      alt={label}
      className="text-[var(--primary-deep)]"
    />
    <span className="text-sm text-[var(--primary-deep)]">{label}</span>
  </div>
);
