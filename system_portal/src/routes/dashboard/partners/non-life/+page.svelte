...
<div class="space-y-8">
	<PageHeader
		title="Non-life partners"
		description="Repair and servicing partner entities available from the backend partner service."
		meta={`${data.partners.length} non-life records`}
	/>
